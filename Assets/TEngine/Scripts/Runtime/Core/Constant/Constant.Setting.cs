namespace TEngine
{
    public static partial class Constant
    {
        ...
        public static class Setting
        {
            ...
            public const string AssetRootPath = "Assets/HotfixRes/";
            public const string AssetBundleMeta = "AssetBundleMeta.bin";
            public const string AssetFilterPath = "Assets/TResources/ArtRaw";
            public const string ArtResourcesPath = "Assets/ArtResources";
